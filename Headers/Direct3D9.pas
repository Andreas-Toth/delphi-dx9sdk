...
{$IFDEF TMT}{$Z1}{$ELSE}{$MINENUMSIZE 1}{$ENDIF}
...
{$IFDEF TMT}{$Z4}{$ELSE}{$MINENUMSIZE 4}{$ENDIF}
...
type
  ...
  {$IFDEF TMT}{$Z1}{$ELSE}{$MINENUMSIZE 1}{$ENDIF} // Forces TD3DShaderComparison be 1 byte enum
  ...
  {$IFDEF TMT}{$Z4}{$ELSE}{$MINENUMSIZE 4}{$ENDIF} // Restores enums to be 4 byte in size
...
{$ENDIF}
  ...
  {$IFDEF TMT}{$Z1}{$ELSE}{$MINENUMSIZE 1}{$ENDIF} // Forces TD3DShaderMiscTypeOffsets be 1 byte enum
...
type
  // Async feedback
  {$IFDEF TMT}{$Z1}{$ELSE}{$MINENUMSIZE 1}{$ENDIF} // Forces TD3DQueryType be 1 byte enum
  _D3DQUERYTYPE = (
    D3DQUERYTYPE_VCACHE                 = 4, { D3DISSUE_END }
    D3DQUERYTYPE_RESOURCEMANAGER        = 5, { D3DISSUE_END }
    D3DQUERYTYPE_VERTEXSTATS            = 6, { D3DISSUE_END }
